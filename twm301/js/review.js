/**
 * TWM 301 Midterm Reviewer — Missed Questions Review Module
  ...
  function renderReviewScreen() {
      ...
      els.missedList.innerHTML = `
        <div class="card missed-empty-state text-center">
          ...
          <p class="text-secondary empty-state-desc">
            You achieved a flawless score on this reviewer session. You have demonstrated comprehensive command of all 7 Technical Writing in Mathematics & LaTeX syllabus topics and are thoroughly prepared for the examination.
          </p>
        </div>
      `;
    ...
    const cardsHtml = missedData.map(item => {
      ...
      if (item.cachedExplanation) {
        ...
        explanationHtml = `
          <div class="explanation-badge" style="margin-bottom: 6px;">
