/**
 * TWM 301 Midterm Reviewer — Results & Syllabus Topic Analytics Engine
...
(function (global) {
  ...
  const SYLLABUS_TOPICS = Object.freeze([
    'Foundational Technical Writing Style & Ethics',
    'LaTeX Ecosystem, Distributions & Tooling',
    'Document Architecture & Preamble Configuration',
    'Mathematical Typesetting & AMS-LaTeX',
    'Customization, Delimiters & Macro Engineering',
    'Floats, Tables & Figures',
    'Content Lists, Cross-Referencing & Bibliographies'
  ]);
  ...
  const GRADE_SCALE = Object.freeze([
    {
      ...
      tip: 'Outstanding mastery! You have demonstrated deep command of LaTeX syntax, AMS-LaTeX mathematical environments, document architecture, BibTeX, and ethical mathematical writing style. You are exceptionally well-prepared for exam day.'
    },
    {
      minPct: 80,
      label: 'Very Good',
      className: 'grade-very-good',
      tip: 'Strong performance! You have a firm grasp of the core LaTeX concepts and editorial principles with only minor gaps. Review your few missed items below for complete confidence.'
    },
    {
      minPct: 70,
      label: 'Good',
      className: 'grade-good',
      tip: 'Solid foundation! You understand the primary formatting and typesetting rules well. Focus your active recall on multi-line equation alignment, delimiter scaling, and cross-referencing to push into top-tier mastery.'
    },
    {
      minPct: 60,
      label: 'Needs Improvement',
      className: 'grade-warning',
      tip: 'Passing baseline achieved, but several critical LaTeX concepts require reinforcement. Pay special attention to the amber-flagged weak topics below before taking the midterm.'
    },
    {
      minPct: 0,
      label: 'Study More',
      className: 'grade-danger',
      tip: 'Comprehensive review strongly recommended. Re-study document preamble configuration, amsmath matrix environments, and BibTeX citation syntax before retaking the reviewer.'
    }
  ]);
