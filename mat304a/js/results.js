/**
 * MAT 304a Midterm Reviewer — Results & Syllabus Topic Analytics Engine
 * 
 * Manages:
...
(function (global) {
  ...
  const SYLLABUS_TOPICS = Object.freeze([
    ...
    'The Simplex Algorithm & Tableaux',
  ...
  const GRADE_SCALE = Object.freeze([
    {
      ...
      tip: 'Outstanding mastery! You have demonstrated deep command of linear programming formulation, simplex tableaux, sensitivity analysis, and artificial variable methods. You are exceptionally well-prepared for exam day.'
    },
    {
      minPct: 80,
      label: 'Very Good',
    ...
    },
    {
      ...
      tip: 'Solid foundation! You understand the primary paradigms well. Focus your active recall on simplex pivoting, shadow price interpretations, and special cases to push into top-tier mastery.'
    },
    {
      minPct: 60,
    ...
    },
    {
      ...
      tip: 'Comprehensive review strongly recommended. Re-study LP standard form conversions, simplex ratio tests, and graphical feasibility regions before retaking the reviewer.'
    }
  ]);
